...
const developer = {
  ...
  university: "Daffodil International University (Class of 2029)",
  code: ["C", "SQL"],
  currentFocus: "Building impactful software & learning new tech",
  openTo: "Collaborations & team projects",
};
```
